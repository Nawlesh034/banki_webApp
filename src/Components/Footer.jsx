        ...
        <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
            ...
            flex-col mb-8 w-full`}>
              ...
              justify-between flex-wrap md:mt-0 mt-10 ">
                ...
                <div key={footer.key} className="flex flex-col
                ss:my-0 my-4 min-w-[150px]">
                    ...
                    <ul className="list-none mt-4">
                        ...
                        <li key={Link.name}
                        className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer ${index !== footer.links.length-1?'mb-4':'mb-0'}`}>
                          {Link.name}
            ...
            item-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
